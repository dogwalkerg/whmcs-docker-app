            ...
            <div class="row">
                <div class="col-sm-6" style="display:none">
                    <div class="form-group prepend-icon">
                        ...
                        <input type="text" name="firstname" id="inputFirstName" class="field form-control" placeholder="{$LANG.orderForm.firstName}" value="客户" {if !in_array('firstname', $optionalFields)}required{/if} autofocus>
                    </div>
                </div>
                <div class="col-sm-6" style="display:none">
                    <div class="form-group prepend-icon">
                        ...
                        <input type="text" name="lastname" id="inputLastName" class="field form-control" placeholder="{$LANG.orderForm.lastName}" value="老爷" {if !in_array('lastname', $optionalFields)}required{/if}>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group prepend-icon">
                        ...
                        <p> <font size="3" color="red">请填写真实有效的邮箱地址，以防自动发货失效。</font></p>
                    </div>
                </div>
                <div class="col-sm-6" style="display:none">
                    <div class="form-group prepend-icon">
                        ...
                        <input type="tel" name="phonenumber" id="inputPhone" class="field" placeholder="{$LANG.orderForm.phoneNumber}" value="10000000000">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12" style="display:none">
                    <div class="form-group prepend-icon">
                        ...
                        <input type="text" name="address1" id="inputAddress1" class="field form-control" placeholder="{$LANG.orderForm.streetAddress}" value="未填写"  {if !in_array('address1', $optionalFields)}required{/if}>
                    </div>
                </div>
                <div class="col-sm-12" style="display:none">
                    <div class="form-group prepend-icon">
                ...
                <div class="col-sm-4" style="display:none">
                    <div class="form-group prepend-icon">
                        ...
                        <input type="text" name="city" id="inputCity" class="field form-control" placeholder="{$LANG.orderForm.city}" value="未填写"  {if !in_array('city', $optionalFields)}required{/if}>
                    </div>
                </div>
                <div class="col-sm-5" style="display:none">
                    <div class="form-group prepend-icon">
                        ...
                        <input type="text" name="state" id="state" class="field form-control" placeholder="{$LANG.orderForm.state}" value="未填写"  {if !in_array('state', $optionalFields)}required{/if}>
                    </div>
                </div>
                <div class="col-sm-3" style="display:none">
                    <div class="form-group prepend-icon">
                        ...
                        <input type="text" name="postcode" id="inputPostcode" class="field form-control" placeholder="{$LANG.orderForm.postcode}" value="100000" {if !in_array('postcode', $optionalFields)}required{/if}>
                    </div>
                </div>
                <div class="col-sm-12" style="display:none">
                    <div class="form-group prepend-icon">
                        ...
                        <select name="country" id="inputCountry" class="field form-control">
                            {foreach $clientcountries as $countryCode => $countryName}
                                <option value="CN"{if (!$clientcountry && $countryCode eq $defaultCountry) || ($countryCode eq $clientcountry)} selected="selected"{/if}>
                                    {$countryName}
                                </option>
                            {/foreach}
                        </select>
